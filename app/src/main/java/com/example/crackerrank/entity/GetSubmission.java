...
public class GetSubmission implements Serializable, Parcelable
{
    ...
    public final static Creator<GetSubmission> CREATOR = new Creator<GetSubmission>() {


        @SuppressWarnings({
            "unchecked"
        })
        public GetSubmission createFromParcel(android.os.Parcel in) {
            return new GetSubmission(in);
        }

        public GetSubmission[] newArray(int size) {
            return (new GetSubmission[size]);
        }

    }
    ;
    private final static long serialVersionUID = -3187163133566629361L;

    protected GetSubmission(android.os.Parcel in) {
     ...
     * @param status
     */
    public GetSubmission(String stdout, String time, Integer memory, Object stderr, String token, Object compileOutput, Object message, Status status) {
        super();
        this.stdout = stdout;
        this.time = time;
        this.memory = memory;
    ...
    public String toString() {
        ...
        sb.append(GetSubmission.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("stdout");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetSubmission) == false) {
            return false;
        }
        GetSubmission rhs = ((GetSubmission) other);
